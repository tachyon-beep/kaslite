...
class SweepCLI:
    ...
    def create_parser(self) -> argparse.ArgumentParser:
        ...
        quick_parser.add_argument(
            ...
            type=int,
            default=10,
            help='Number of quick trials (default: 10)'
        )
    ...
    def run_quick_test(self, args: argparse.Namespace) -> int:
        ...
        if len(combinations) > args.trials:
            ...
            self.console.print(f"[yellow]Limiting to {args.trials} trials (sampled from {len(config.get_grid_combinations())} possible combinations)[/yellow]")
