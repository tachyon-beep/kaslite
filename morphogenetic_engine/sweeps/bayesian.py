...
class BayesianSearchRunner:
        ...
        for param_name, param_config in search_space.items():
            if isinstance(param_config, dict):
                ...
                if param_type == 'categorical':
                    ...
                    self.console.print(f"[yellow]Unknown parameter type {param_type} for {param_name}, treating as categorical[/yellow]")
    ...
    def _save_study_results(self):
        ...
        study_summary = {
            ...
            } if self.study.best_trial else None,
            'trials': [
                {
                    'number': trial.number,
                    'value': trial.value,
    ...
    def _print_summary(self):
        ...
        table.add_row("Successful trials", str(len([t for t in self.study.trials if t.state == optuna.trial.TrialState.COMPLETE])))
