...
class TestExperimentSlugGeneration:
    ...
    @pytest.mark.parametrize("problem_type,expected_prefix", [
        ("spirals", "spirals"),
        ("moons", "moons"),
...
class TestExperimentConfiguration:
    ...
    def test_create_experiment_config_basic(self):
        ...
        required_fields = [
            ...
            "device", "seed", "warm_up_epochs", "adaptation_epochs", "lr",
            "hidden_dim", "num_layers", "seeds_per_layer", "blend_steps",
            "shadow_lr", "progress_thresh", "drift_warn", "acc_threshold"
        ]
