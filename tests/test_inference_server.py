...
def test_predict_specific_model_version(
    ...
    prediction_request_with_version: dict[str, Any]
) -> None:
...
# Model Reload Tests
@pytest.mark.asyncio
async def test_reload_model_success(sync_client: TestClient, mocker, mock_model_registry) -> None:  # pylint: disable=unused-argument
