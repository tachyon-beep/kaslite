...
def build_model_and_agents(args, device):
    ...
    kasmina = KasminaMicro(
        seed_manager, patience=15, delta=5e-4, acc_threshold=args.acc_threshold
    )
...
def execute_phase_2(config, model, loaders, loss_fn, seed_manager, kasmina, logger, log_f, initial_best_acc):
...
def main():
    """Main function to orchestrate the morphogenetic architecture experiment."""
